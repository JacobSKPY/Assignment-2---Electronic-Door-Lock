...
HD_PWD='C:/Users/jacob/Assig_2V2/Assig_2V2.runs/Keypad_encoder_decoder_keypad_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Keypad_encoder_decoder_keypad_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Keypad_encoder_decoder_keypad_0_0.tcl
