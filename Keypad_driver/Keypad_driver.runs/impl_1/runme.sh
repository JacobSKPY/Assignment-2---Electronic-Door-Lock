...
HD_PWD='C:/Users/jacob/Keypad_driver/Keypad_driver.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Keypad_encoder_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Keypad_encoder_wrapper.tcl -notrace
