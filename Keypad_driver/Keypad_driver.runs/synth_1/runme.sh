...
HD_PWD='C:/Users/jacob/Keypad_driver/Keypad_driver.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Keypad_encoder_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Keypad_encoder_wrapper.tcl
