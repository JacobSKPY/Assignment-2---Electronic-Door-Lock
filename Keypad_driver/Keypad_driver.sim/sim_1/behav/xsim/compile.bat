...
REM
REM Generated by Vivado on Wed Apr 08 12:53:04 +0200 2026
...
echo "xvhdl --incr --relax -prj Keypad_encoder_wrapper_vhdl.prj"
call xvhdl  --incr --relax -prj Keypad_encoder_wrapper_vhdl.prj -log xvhdl.log
