...
#
# Script generated by Vivado on Thu Apr 09 12:51:56 +0200 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : Keypad_encoder.sh
...
#
# Usage        : Keypad_encoder.sh
#                Keypad_encoder.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Keypad_encoder.sh [-rerun]
#                Keypad_encoder.sh [-reset_run]
#                Keypad_encoder.sh [-clean]
#                Keypad_encoder.sh [-reset_log]
#                Keypad_encoder.sh [-help]
#
...
# script info
echo -e "Keypad_encoder.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Keypad_encoder.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L secureip -L xpm --snapshot Keypad_encoder xil_defaultlib.Keypad_encoder -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim Keypad_encoder -key {Behavioral:sim_1:Functional:Keypad_encoder} -tclbatch cmd.tcl -protoinst "protoinst_files/Keypad_encoder.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb Keypad_encoder.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./Keypad_encoder.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: Keypad_encoder.sh [-help]\n\
Usage: Keypad_encoder.sh [-step]\n\
Usage: Keypad_encoder.sh [-lib_map_path]\n\
Usage: Keypad_encoder.sh [-rerun]\n\
Usage: Keypad_encoder.sh [-reset_run]\n\
Usage: Keypad_encoder.sh [-clean]\n\
Usage: Keypad_encoder.sh [-reset_log]\n\
Usage: Keypad_encoder.sh [-keep_index]\n\
Usage: Keypad_encoder.sh [-noclean_files]\n\n\
