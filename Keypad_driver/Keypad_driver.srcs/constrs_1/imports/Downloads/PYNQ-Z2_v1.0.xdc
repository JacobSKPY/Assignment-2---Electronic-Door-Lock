...
# intr output
set_property -dict { PACKAGE_PIN L15 IOSTANDARD LVCMOS33 } [get_ports { intr }];
...
# LEDs - key_c output (fra dit block design)
set_property -dict { PACKAGE_PIN R14 IOSTANDARD LVCMOS33 } [get_ports { key_out[0] }];
set_property -dict { PACKAGE_PIN P14 IOSTANDARD LVCMOS33 } [get_ports { key_out[1] }];
set_property -dict { PACKAGE_PIN N16 IOSTANDARD LVCMOS33 } [get_ports { key_out[2] }];
set_property -dict { PACKAGE_PIN M14 IOSTANDARD LVCMOS33 } [get_ports { key_out[3] }];
...
# PmodA - Rows (FPGA → Keypad)
# set_property -dict { PACKAGE_PIN Y19 IOSTANDARD LVCMOS33 } [get_ports { row_out[1] }];
# set_property -dict { PACKAGE_PIN Y16 IOSTANDARD LVCMOS33 } [get_ports { row_out[2] }];
# set_property -dict { PACKAGE_PIN Y17 IOSTANDARD LVCMOS33 } [get_ports { row_out[3] }];

# PmodA - Cols (Keypad → FPGA)
# set_property -dict { PACKAGE_PIN U18 IOSTANDARD LVCMOS33 } [get_ports { col_in[0] }];
# set_property -dict { PACKAGE_PIN U19 IOSTANDARD LVCMOS33 } [get_ports { col_in[1] }];
# set_property -dict { PACKAGE_PIN W18 IOSTANDARD LVCMOS33 } [get_ports { col_in[2] }];
# set_property -dict { PACKAGE_PIN W19 IOSTANDARD LVCMOS33 } [get_ports { col_in[3] }];

##PmodB

set_property -dict { PACKAGE_PIN W14  IOSTANDARD LVCMOS33 } [get_ports { col_in[3] }]
set_property -dict { PACKAGE_PIN Y14  IOSTANDARD LVCMOS33 } [get_ports { col_in[2] }]
set_property -dict { PACKAGE_PIN T11  IOSTANDARD LVCMOS33 } [get_ports { col_in[1] }]
set_property -dict { PACKAGE_PIN T10  IOSTANDARD LVCMOS33 } [get_ports { col_in[0] }]

set_property -dict { PACKAGE_PIN V16  IOSTANDARD LVCMOS33 } [get_ports { row_out[3] }]
set_property -dict { PACKAGE_PIN W16  IOSTANDARD LVCMOS33 } [get_ports { row_out[2] }]
set_property -dict { PACKAGE_PIN V12  IOSTANDARD LVCMOS33 } [get_ports { row_out[1] }]
set_property -dict { PACKAGE_PIN W13  IOSTANDARD LVCMOS33 } [get_ports { row_out[0] }]
